...
|:---------------------|:--------------| -------:|
| `‑k int`   | Set the value of k, i.e. the length of k-mers to be counted. Supported k currently ranges from 8 to 136. Support for values larger than 136 can easily be activated if needed. | 28 |
